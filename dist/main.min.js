...
var WorkManager = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (this.WorkObjectPool[name].pointer)
                            this.resetPointer(work.view);
    ...
    WorkManager.prototype.onMousemove = function (e) {
        if (!work.pointer.enable)
            return;
        work.pointer.mx = e.movementX;
        work.pointer.my = e.movementY;
        work.pointer.update = true;
    };
    WorkManager.prototype.onClick = function () {
        if (!work.pointer.enable)
            return;
        work.pointer.lock = true;
        work.view.requestPointerLock();
    };
    WorkManager.prototype.onPointerLockChange = function () {
    ...
    WorkManager.prototype.delPointer = function (view) {
        if (!view)
            return;
        work.pointer = {
            mx: 0,
    ...
    WorkManager.prototype.resetPointer = function (view) {
        work.pointer = {
            mx: 0,
            my: 0,
            update: false,
...
var PointerWork = /** @class */ (function (_super) {
    __extends(PointerWork, _super);
    function PointerWork() {
        ...
        _this.sensitivity = 0.005;
        _this.yaw = 0;
        _this.pitch = 0;
        return _this;
    }
    PointerWork.prototype.init = function () {
        var _this = this;
    ...
    PointerWork.prototype.update = function () {
        if (this.work.pointer.lock && this.work.pointer.update) {
            var front = vec3.create();
            var x = this.work.pointer.mx * this.sensitivity;
            var y = this.work.pointer.my * this.sensitivity;
            var yaw = this.yaw += x;
            var pitch = this.pitch += -y;
            if (pitch > 1.55)
    ...
    (function (Lighting_1) {
        var Lighting = /** @class */ (function (_super) {
            ...
            Lighting.prototype.init = function () {
                return __awaiter(this, void 0, void 0, function () {
                    var gl, _a, shader, _b, program, VBO, v, aPos, aNormal;
                    var _this = this;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
    ...
    (function (Lighting) {
        var Map = /** @class */ (function (_super) {
            ...
            Map.prototype.init = function () {
                return __awaiter(this, void 0, void 0, function () {
                    var gl, _a, shader, _b, program, VBO, v, aPos, aNormal, aTexCoord;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                            ...
                            case 1:
                                _a.lampshader = _c.sent();
                                _b = this;
                                return [4 /*yield*/, Shader.create('./glsl/lighting/map.vert', './glsl/lighting/map.frag', gl)];
                            case 2:
                                shader = _b.shader = _c.sent();
                                program = this.program = shader.ID;
                                VBO = this.VBO = gl.createBuffer();
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 1:
                                _a.lampshader = _c.sent();
                                _b = this;
                                return [4 /*yield*/, Shader.create('./glsl/lighting/lighting.normal.vert', './glsl/lighting/materials.frag', gl)];
                            case 2:
                                shader = _b.shader = _c.sent();
                                program = this.program = shader.ID;
                                VBO = this.VBO = gl.createBuffer();
